...
export default function HistoryPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 pt-12 pb-24 px-6 md:px-12">
          ...
          >
            ...
            {items.length > 0 && (
              <button
                ...
                className="px-6 py-3 rounded-xl border border-red-500/20 bg-red-500/5 text-red-400 text-sm font-medium hover:bg-red-500/10 transition-colors flex items-center gap-2"
              >
            ...
            <div className="space-y-3">
              {filteredItems.map((item, i) => (
                <motion.div
                  ...
                  className="glass-card p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 hover:border-cyan-500/20 transition-all group"
                >
                  ...
                  <Link
                    ...
                    className="w-full md:w-auto px-8 py-3.5 text-center rounded-xl border border-white/5 bg-white/[0.02] text-white/60 text-sm font-medium group-hover:text-cyan-400 group-hover:border-cyan-500/20 group-hover:bg-cyan-500/5 transition-all flex items-center justify-center gap-2"
                  >
                    View Analysis
                    <ArrowRight className="w-4 h-4" />
                  </Link>
